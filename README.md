...
Before, you need to go to [OpenWeatherMap] (https://openweathermap.org/api).
You need to sign in and ask for an API key which will be usefull for the future request.
## Table of Contents
